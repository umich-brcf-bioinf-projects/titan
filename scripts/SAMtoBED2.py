...
def parseSAM(fIn, fOut, singleOpt, addBP, extendOpt,
    sortOpt, histFile, verbose, emptyfile):
  '''
...
def main():
  ...
  other.add_argument('-e', '--emptyfile', dest='emptyfile',
    action='store_true', help='Create empty ' +
    'if no valid paired-reads are found')
